...
class GetProductImage extends Usecase<Failure, List<ProductImageModel>> {
  final IProductDetailRepository _repository = locator.get();

  @override
  Future<Either<Failure, List<ProductImageModel>>> call(Params? params) {
    var productParams = params != null ? params as ProductParams : null;
    return _repository.getProuctImage(productParams!.productId);
  }
}
